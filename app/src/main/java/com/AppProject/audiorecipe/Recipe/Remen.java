...
public class Remen extends AppCompatActivity implements SensorEventListener {
    ...
    class RemenThread extends Thread {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), RemenDetail.class);
        ...
        if(event.sensor.getType() == Sensor.TYPE_LIGHT){
            if(event.values[0] < 50.0f){
                ...
                if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.RECORD_AUDIO) !=
                    ...
                    ActivityCompat.requestPermissions(Remen.this, new String[]{Manifest.permission.RECORD_AUDIO}, 1);
                    //권한을 허용하지 않는 경우
                } else {
                    //권한을 허용한 경우
                    try {
