...
public class Duruchigi extends AppCompatActivity implements SensorEventListener {
    ...
    class DuruchigiThread extends Thread {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.duruchigi);
        ...
        ImageView imageView = (ImageView) findViewById(R.id.recipeview5);
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), DuruchigiDetail.class);
        ...
        mp = MediaPlayer.create(Duruchigi.this, R.raw.duruchigimp);
        ...
        bStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DuruchigiThread().start(); // 씨크바 그려줄 쓰레드 시작
        ...
        if(event.sensor.getType() == Sensor.TYPE_LIGHT){
            if(event.values[0] < 50.0f){
                ...
                if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.RECORD_AUDIO) !=
                    ...
                    ActivityCompat.requestPermissions(Duruchigi.this, new String[]{Manifest.permission.RECORD_AUDIO}, 1);
                    //권한을 허용하지 않는 경우
                } else {
                    //권한을 허용한 경우
                    try {
