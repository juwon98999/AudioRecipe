...
public class RemenDetail extends AppCompatActivity implements SensorEventListener {
    ...
    class KimchiDetailThread extends Thread {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.remendetail);
        ...
        sb.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                mp.seekTo(ttt);
                mp.start();
                new RemenDetail.KimchiDetailThread().start();
            }
        ...
        bStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new RemenDetail.KimchiDetailThread().start(); // 씨크바 그려줄 쓰레드 시작
        ...
        if(event.sensor.getType() == Sensor.TYPE_LIGHT){
            if(event.values[0] < 50.0f){
                ...
                if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.RECORD_AUDIO) !=
                    ...
                    ActivityCompat.requestPermissions(RemenDetail.this, new String[]{Manifest.permission.RECORD_AUDIO}, 1);
                    //권한을 허용하지 않는 경우
                } else {
                    //권한을 허용한 경우
                    try {
