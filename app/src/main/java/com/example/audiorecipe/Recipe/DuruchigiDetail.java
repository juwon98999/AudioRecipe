...
public class DuruchigiDetail extends AppCompatActivity implements SensorEventListener {
    ...
    class DuruchigiDetailThread extends Thread {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.duruchigidetail);
        ...
        sb.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                mp.seekTo(ttt);
                mp.start();
                new DuruchigiDetailThread().start();
            }
        ...
        if(event.sensor.getType() == Sensor.TYPE_LIGHT){
            if(event.values[0] < 50.0f){
                ...
                if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.RECORD_AUDIO) !=
                    ...
                    ActivityCompat.requestPermissions(DuruchigiDetail.this, new String[]{Manifest.permission.RECORD_AUDIO}, 1);
                    //권한을 허용하지 않는 경우
                } else {
                    //권한을 허용한 경우
                    try {
